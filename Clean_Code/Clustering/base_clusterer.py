...
regardless of whether they are embedding-based or cross-encoder-based.
"""
...
class BaseClusterer(ABC):
    ...
    and approaches (embedding-based or cross-encoder-based).
    """
    ...
    def fit(self, vectors: np.ndarray, data: Optional[List[Any]] = None) -> 'BaseClusterer':
        ...
        Args:
            ...
            data: Optional additional data associated with each vector
                (e.g., texts, product IDs, metadata, etc.)
    ...
    def get_clusters(self) -> List[Dict[str, Any]]:
        ...
        Returns:
            List of dictionaries, one per cluster, containing:
                ...
                - 'centroid': Centroid of the cluster (if applicable)
    ...
    def get_metrics(self) -> Dict[str, float]:
        ...
        Returns:
            Dictionary of metric names and values, potentially including:
                - 'num_clusters': Number of clusters found
                - 'silhouette_score': Silhouette score (if applicable)
                - 'davies_bouldin_score': Davies-Bouldin index (if applicable)
                - 'calinski_harabasz_score': Calinski-Harabasz index (if applicable)
                - 'noise_percentage': Percentage of noise points (if applicable)
    ...
    def visualize(self, dim_reduction: str = 'tsne', **kwargs) -> Dict[str, Any]:
        ...
        raise NotImplementedError(
            ...
            "Use the visualization utilities from the Analytics module or "
